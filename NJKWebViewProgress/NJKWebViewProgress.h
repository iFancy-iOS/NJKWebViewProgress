...
@interface NJKWebViewProgress : NSObject <UIWebViewDelegate, WKUIDelegate, WKNavigationDelegate>
...
@property (nonatomic, njk_weak) id<WKNavigationDelegate>wkWebViewProxyDelegate;
